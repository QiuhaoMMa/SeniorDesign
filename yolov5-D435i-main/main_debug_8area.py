...
model = torch.hub.load('ultralytics/yolov5', 'custom', r'/home/qiuhao/yolov5-D435i-main/crop_best.pt')
model.conf = 0.5
...
if __name__ == "__main__":
    ...
    ser = serial.Serial('/dev/ttyACM1', 9600)  # Replace '/dev/ttyUSBX' with the correct serial port
    time.sleep(3)
    ser.write(b'M')
